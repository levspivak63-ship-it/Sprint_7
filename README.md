Проект автоматизации с изменениями и дополнениями по результатам ревью.
Внесены измения и дополнения: фикстуры использованы в тестах, изменен модуль data, убраны дублирующие проверки, добавлены проверки ответов. В результате проверки ответов установлено несоответствие текстов ответов документации API: непредусмотренные указания кодов ошибок (например code': 404), ошибки сиснтаксиса, лишний текст. Подробный отчет представлен в allure-report.
